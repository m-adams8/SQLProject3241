...
-- Insert data into Employee_SSN table
INSERT INTO Employee_SSN (Employee_ID, SSN) VALUES
(1,123456789),
(2,234567890),
(3,345678901),
(4,456789012),
...
(59,592345727),
(60,602345728);
INSERT INTO Employee (Employee_ID, F_Name, M_Name, L_Name, Phone, Salary, Job_Type) VALUES
(1, 'John', 'A', 'Doe', 5551234567, 55000, "Worker"),
(2, 'Jane', 'B', 'Smith', 5552345678, 60000, "Worker"),
(3, 'James', 'C', 'Brown', 5553456789, 58000, "Worker"),
(4, 'Emily', 'D', 'Davis', 5554567890, 62000, "Worker"),
(5, 'Michael', 'E', 'Wilson', 5555678901, 63000, "Worker"),
(6, 'Sarah', 'F', 'Miller',  5556789012, 59000, "Worker"),
(7, 'David', 'G', 'Martinez', 5557890123, 61000, "Worker"),
(8, 'Laura', 'H', 'Garcia', 5558901234, 57000, "Worker"),
(9, 'Chris', 'I', 'Anderson', 5559012345, 65000, "Worker"),
(10, 'Amy', 'J', 'Thomas', 5551023456, 56000, "Worker"),
(11, 'Brian', 'K', 'Jackson', 5551123457, 64000, "Worker"),
(12, 'Rachel', 'L', 'White', 5551223458, 66000, "Worker"),
(13, 'Kevin', 'M', 'Harris', 5551323459, 67000, "Worker"),
(14, 'Olivia', 'N', 'Clark', 5551423460, 63000, "Worker"),
(15, 'Jeff', 'O', 'Lewis', 5551523461, 61000, "Worker"),
(16, 'Victoria', 'P', 'Young', 5551623462, 62000, "Worker"),
(17, 'Frank', 'Q', 'Hall', 5551723463, 59000, "Worker"),
(18, 'Sophia', 'R', 'Allen', 5551823464, 65000, "Worker"),
(19, 'Ethan', 'S', 'King', 551923465, 60000, "Worker"),
(20, 'Madison', 'T', 'Scott', 5552023466, 57000, "Worker"),
(21, 'Daniel', 'U', 'Green', 5552123467, 62000, "Guard"),
(22, 'Grace', 'V', 'Baker', 5552223468, 58000, "Guard"),
(23, 'Matthew', 'W', 'Gonzalez', 5552323469, 63000, "Guard"),
(24, 'Hannah', 'X', 'Carter', 5552423470, 66000, "Guard"),
(25, 'Anthony', 'Y', 'Mitchell', 5552523471, 67000, "Guard"),
(26, 'Ava', 'Z', 'Perez', 5552623472, 59000, "Guard"),
(27, 'Mark', 'A', 'Roberts', 5552723473, 61000, "Guard"),
(28, 'Mia', 'B', 'Turner', 5552823474, 64000, "Guard"),
(29, 'Ryan', 'C', 'Phillips', 5552923475, 60000, "Guard"),
(30, 'Ella', 'D', 'Campbell', 5553023476, 65000, "Guard"),
(31, 'Justin', 'E', 'Parker', 5553123477, 62000, "Guard"),
(32, 'Zoe', 'F', 'Evans', 5553223478, 58000, "Guard"),
(33, 'Joshua', 'G', 'Edwards', 5553323479, 67000, "Guard"),
(34, 'Lily', 'H', 'Collins', 5553423480, 63000, "Guard"),
(35, 'Nathan', 'I', 'Stewart', 5553523481, 61000, "Guard"),
(36, 'Sofia', 'J', 'Sanchez', 5553623482, 66000, "Guard"),
(37, 'Benjamin', 'K', 'Morris', 5553723483, 62000, "Guard"),
(38, 'Chloe', 'L', 'Rogers', 5553823484, 59000, "Guard"),
(39, 'Alexander', 'M', 'Reed', 5553923485, 65000, "Guard"),
(40, 'Aria', 'N', 'Cook', 5554023486, 67000, "Guard"),
(41, 'Samuel', 'O', 'Morgan', 5554123487, 64000, "Manager"),
(42, 'Elizabeth', 'P', 'Bell', 5554223488, 60000, "Manager"),
(43, 'Jacob', 'Q', 'Murphy', 5554323489, 58000, "Manager"),
(44, 'Scarlett', 'R', 'Bailey', 5554423490, 66000, "Manager"),
(45, 'Henry', 'S', 'Rivera', 5554523491, 62000, "Manager"),
(46, 'Evelyn', 'T', 'Cooper', 5554623492, 65000, "Manager"),
(47, 'Logan', 'U', 'Richardson', 5554723493, 67000, "Manager"),
(48, 'Ella', 'V', 'Cox', 5554823494, 59000, "Manager"),
(49, 'Lucas', 'W', 'Howard', 5554923495, 63000, "Manager"),
(50, 'Zoe', 'X', 'Ward', 5555023496, 61000, "Manager"),
(51, 'Gabriel', 'Y', 'Torres', 5555123497, 66000, "Manager"),
(52, 'Layla', 'Z', 'Peterson', 5555223498, 62000, "Manager"),
(53, 'Daniel', 'A', 'Gray', 5555323499, 64000, "Manager"),
(54, 'Nora', 'B', 'Ramirez', 5555423500, 61000, "Manager"),
(55, 'David', 'C', 'James', 5555523501, 67000, "Manager"),
(56, 'Riley', 'D', 'Watson', 5555623502, 65000, "Manager"),
(57, 'Adam', 'E', 'Brooks', 5555723503, 60000, "Manager"),
(58, 'Victoria', 'F', 'Kelly', 5555823504, 58000, "Manager"),
(59, 'Hunter', 'G', 'Sanders', 5555923505, 67000, "Manager"),
(60, 'Lucy', 'H', 'Price', 5556023506, 64000, "Manager");
...
INSERT INTO Card_Info(Type,Card_ID, Expiration, SSV) VALUES
('Visa', 1234567812345678, '2025-12-31', '123'),
('MasterCard', 2345678923456789, '2024-11-30', '234'),
('American Express', 3456789034567890, '2023-10-31', '345'),
('Discover', 4567890145678901, '2026-09-30', '456'),
('Visa', 5678901256789012, '2025-08-31', '567'),
('MasterCard', 6789012367890123, '2024-07-31', '678'),
('American Express', 7890123478901234, '2023-06-30', '789'),
('Discover', 8901234589012345, '2026-05-31', '890'),
('Visa', 9012345690123456, '2025-04-30', '901'),
('MasterCard', 1234567801234567, '2024-03-31', '012'),
('American Express', 2345678912345678, '2023-02-28', '123'),
('Discover', 3456789023456789, '2026-01-31', '234'),
('Visa', 4567890134567890, '2025-12-31', '345'),
('MasterCard', 5678901245678901, '2024-11-30', '456'),
('American Express', 6789012356789012, '2023-10-31', '567'),
('Discover', 7890123467890123, '2026-09-30', '678'),
('Visa', 8901234578901234, '2025-08-31', '789'),
('MasterCard', 9012345689012345, '2024-07-31', '890'),
('American Express', 1234567890123456, '2023-06-30', '901'),
('Discover', 2345678901234567, '2026-05-31', '012');

INSERT INTO Card (Payment_Method_ID, Card_ID) VALUES
(3,1234567812345678),
(3, 2345678923456789),
(3, 3456789034567890),
(3, 4567890145678901),
